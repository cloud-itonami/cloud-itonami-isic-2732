# Operator Quickstart — Manufacture of Other Electronic and Electric Wires and Cables

Shortest path from clone to a verified local dry-run for **ISIC 2732** (`cloud-itonami-isic-2732`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-2732.git
cd cloud-itonami-isic-2732
```
...
- Blueprint governor key: `cable-integrity-governor`
- Likely source path: `harnessworks.governor.cljc`
